...
#define CAMERA_MOUSE_SCROLL_SENSITIVITY                 2.0f
...
// ORBITAL_CAMERA
#define CAMERA_ORBITAL_SPEED                            0.05f       // Radians per frame

// FIRST_PERSON
#define CAMERA_FIRST_PERSON_MOUSE_SENSITIVITY           0.1f
#define CAMERA_FIRST_PERSON_FOCUS_DISTANCE              50.0f
#define CAMERA_FIRST_PERSON_MIN_CLAMP                   100.0f
#define CAMERA_FIRST_PERSON_MAX_CLAMP                  -100.0f

#define CAMERA_FIRST_PERSON_STEP_TRIGONOMETRIC_DIVIDER  60.0f
#define CAMERA_FIRST_PERSON_STEP_DIVIDER                240.0f
#define CAMERA_FIRST_PERSON_WAVING_DIVIDER              12240.0f
...
#define PLAYER_MOVEMENT_SENSITIVITY                     120.0f
